...
#####################
### Main Features:
###   1. Backs up Softwares on Ubuntu distros
###   2. Generates Bash script to restore them back
...
###   - And Must be run with sudo
### Example: 'sudo ruby backup.rb ~/backups/configs/servername.example.com.json true'
